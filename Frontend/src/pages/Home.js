        ...
        <div className="home">
            ...
            <section className="content">
                <div className="home-content">
                    ...
                    <div className="search">
                        <input type="text" placeholder="Search for talents" />
            ...
            <section className="join-as-artisan">
                ...
                <div className="join-content">
                    ...
                    <div className="Craftsman">
                        <div className="Craftsman-images">
                        ...
                        <div className="collaborate-contents">
                            <h2>Service Provider</h2>
                            <p>Provide services and earn by connecting with customers</p>
                            <button className="join-buttons">Partner with us</button>
                        </div>
                    </div>
